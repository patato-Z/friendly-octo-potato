...
# sys.path.append('/path/to/FuxiCTR')
sys.path.append('/home/tudou/work/code/FuxiCTR-2.3.6')
...
class finalnet(nn.Module):
    def __init__(self, 
        ...
        if block_type == "2B":
            self.block2 = FinalBlock(input_dim=args.embedding_dim * num_fields,
